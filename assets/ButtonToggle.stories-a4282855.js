var y=Object.defineProperty;var o=(t,r)=>y(t,"name",{value:r,configurable:!0});import{j as e,r as s,R as m}from"./jsx-runtime-451690fa.js";import{a as x}from"./index-f6fb4ba6.js";import{I as u}from"./Icon-96a441ee.js";import"./iframe-655d5b22.js";import"./make-decorator-5b0a2a6f.js";import"./index-50ee27ec.js";function p({children:t,onChange:r,activeChild:l}){const c=o(()=>{r("left")},"handleLeftClick"),i=o(()=>{r("right")},"handleRightClick");return e("div",{className:" flex h-10  w-fit rounded-lg items-center font-roboto  text-sm  border border-brand-primary-dark ",children:s.Children.map(t,(n,b)=>{if(m.isValidElement(n)){const g={active:l==="left",onClick:c};return n.type===d&&(g.active=l==="right",g.onClick=i),m.cloneElement(n,g)}return n})})}o(p,"ButtonToggleRoot");function f({...t}){return e(h,{...t})}o(f,"ButtonToggleLeft");function d({...t}){return e(h,{...t})}o(d,"ButtonToggleRight");function h({children:t,active:r=!1,...l}){return e("div",{className:`
            ...
            `,...l,children:t})}o(h,"ButtonToggleChild");p.displayName="ButtonToggle.Root";f.displayName="ButtonToggle.Left";d.displayName="ButtonToggle.Right";const a={Root:p,Left:f,Right:d},k={parameters:{storySource:{source:`import { ComponentMeta, ComponentStory } from '@storybook/react';
